...
namespace-preparation: ## Prepare the istio-system namespace with default StorageClass
	kubectl apply -f /home/ubuntu/k8s-manifests/istio-system/0.namespace-preparation/0.namespace.yaml
	kubectl apply -f /home/ubuntu/k8s-manifests/istio-system/0.namespace-preparation/1.storageClass.yaml
	kubectl apply -f /home/ubuntu/k8s-manifests/istio-system/0.namespace-preparation/2.pvc.yaml
